...
@Service("tBBusionlineInfoService")
@Transactional
public class TBBusionlineInfoServiceImpl extends CommonServiceImpl implements TBBusionlineInfoServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TBBusionlineInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(TBBusionlineInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(TBBusionlineInfoEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(TBBusionlineInfoEntity t){
		...
		map.put("businame", t.getBusiname());
		map.put("businameshort", t.getBusinameshort());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TBBusionlineInfoEntity t){
 		sql  = sql.replace("#{id}",String.valueOf(t.getId()));
 		sql  = sql.replace("#{create_name}",String.valueOf(t.getCreateName()));
 		sql  = sql.replace("#{create_date}",String.valueOf(t.getCreateDate()));
 		sql  = sql.replace("#{update_name}",String.valueOf(t.getUpdateName()));
 		sql  = sql.replace("#{update_date}",String.valueOf(t.getUpdateDate()));
 		sql  = sql.replace("#{businame}",String.valueOf(t.getBusiname()));
 		sql  = sql.replace("#{businameshort}",String.valueOf(t.getBusinameshort()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("t_b_busionline_info",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
