package configtools.tBOnlineDoc.service.impl;
...
@Service("tBOnlineDocService")
@Transactional
public class TBOnlineDocServiceImpl extends CommonServiceImpl implements TBOnlineDocServiceI {
