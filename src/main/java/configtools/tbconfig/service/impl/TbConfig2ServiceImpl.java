...
@Service("tbConfig2Service")
@Transactional
public class TbConfig2ServiceImpl extends CommonServiceImpl implements TbConfig2ServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TbConfig2Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(TbConfig2Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(TbConfig2Entity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(TbConfig2Entity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TbConfig2Entity t){
