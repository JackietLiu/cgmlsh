package com.jeecg.tShDrugValueInfoNew.service.impl;
...
@Service("tShDrugValueInfoNewService")
@Transactional
public class TShDrugValueInfoNewServiceImpl extends CommonServiceImpl implements TShDrugValueInfoNewServiceI {
