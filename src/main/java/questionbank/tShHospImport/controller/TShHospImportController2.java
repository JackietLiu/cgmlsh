 ...
 * @date 2019-02-21 10:45:08
 * @version V1.0   
 *
 */
@Controller
@RequestMapping("/tShHospImportController2")
public class TShHospImportController2 extends BaseController {
	private static final Logger logger = LoggerFactory.getLogger(TShHospImportController2.class);
...
//zczadd end modify  on  2019/2/28 14:03
	...
	public String exportXls(TShHospImportEntity tShHospImport,HttpServletRequest request,HttpServletResponse response
		...
		modelMap.put(NormalExcelConstants.FILE_NAME,"医院上传信息");
		modelMap.put(NormalExcelConstants.CLASS,TShHospImportEntity.class);
		modelMap.put(NormalExcelConstants.PARAMS,new ExportParams("医院上传信息列表", "导出人:"+ResourceUtil.getSessionUser().getRealName(),
			"导出信息"));
