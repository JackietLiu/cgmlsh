package questionbank.tShRoleRegionMatch.service.impl;
...
@Service("tShRoleRegionMatchService")
@Transactional
public class TShRoleRegionMatchServiceImpl extends CommonServiceImpl implements TShRoleRegionMatchServiceI {
