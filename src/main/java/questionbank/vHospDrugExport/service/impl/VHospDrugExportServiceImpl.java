package questionbank.vHospDrugExport.service.impl;
...
@Service("vHospDrugExportService")
@Transactional
public class VHospDrugExportServiceImpl extends CommonServiceImpl implements VHospDrugExportServiceI {
