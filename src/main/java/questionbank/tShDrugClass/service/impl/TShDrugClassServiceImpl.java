package questionbank.tShDrugClass.service.impl;
...
@Service("tShDrugClassService")
@Transactional
public class TShDrugClassServiceImpl extends CommonServiceImpl implements TShDrugClassServiceI {
