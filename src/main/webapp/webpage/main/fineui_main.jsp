...
<head>
    ...
    <title><t:mutiLang langKey="sys.headtext"/></title>
	...
	<div class="layout-admin">
		...
		<header class="layout-header">
			<span class="header-logo">
				<%--liu-update-begin--%>
				<img alt="image" width="61" height="61" src="myimages/plat_logo.png" /></span>
				<span style="font-size: 22px;color: #fff;"><t:mutiLang langKey="sys.headtext"/></span>
