...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <form id="formobj" action="vHospDrugExportController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="contractname" name="contractname" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入项目名称"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="enterprisename" name="enterprisename" type="text" maxlength="255" class="form-control input-sm" placeholder="请输入生产企业"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="inprice" name="inprice" type="text" maxlength="10" class="form-control input-sm" placeholder="请输入供应价"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="minunitprice" name="minunitprice" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入最小单位报价"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="drugmemo" name="drugmemo" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入国基标注"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="groupno" name="groupno" type="text" maxlength="40" class="form-control input-sm" placeholder="请输入评审编号"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="hospcode" name="hospcode" type="text" maxlength="40" class="form-control input-sm" placeholder="请输入代码"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="hospname" name="hospname" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入医院名称"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="name" name="name" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入城市名"  ignore="ignore" />
			</div>
		</div>
	</div>
</form>
