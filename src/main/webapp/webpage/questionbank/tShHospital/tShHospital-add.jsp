...
<t:base type="jquery,easyui,tools,bootstrap,bootstrap-table,layer,validform,webuploader,bootstrap-form"></t:base>
 ...
 <form id="formobj" action="tShHospitalController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
	...
	<input type="hidden" id="id" name="id"/>
	 ...
	 <div class="form-group">
		 ...
		 <div class="col-sm-7">
			 <div class="input-group" style="width:100%">
				 <input id="hospnameshort" name="hospnameshort" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入简称"  ignore="ignore" />
			 </div>
		 </div>
	 </div>
	 <div class="form-group">
		 ...
		 <div class="col-sm-7">
			 <div class="input-group" style="width:100%">
				 <input id="hospcode" name="hospcode" type="text" maxlength="40" class="form-control input-sm" placeholder="请输入代码"  datatype="*"  ignore="checked" />
			 </div>
		 </div>
	 </div>
	 <div class="form-group">
		 ...
		 <div class="col-sm-7">
			 <div class="input-group" style="width:100%">
				 <t:dictSelect field="hosplevel" type="list" extendJson="{class:'form-control input-sm'}"   typeGroupCode="hosplevel"  hasLabel="false"  title="等级"></t:dictSelect>
			 </div>
		 </div>
	 </div>
	 <div class="form-group">
		 ...
		 <div class="col-sm-7">
			 <div class="input-group" style="width:100%">
				 <input id="regcode" name="regcode" type="text" maxlength="200" class="form-control input-sm" placeholder="请输入注册码"  ignore="ignore" />
			 </div>
		 </div>
	 </div>
	 <div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="address" name="address" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入地址"  ignore="ignore" />
			</div>
		</div>
	</div>
	 ...
	 <div class="form-group">
		 ...
		 <div class="col-sm-7">
			 <div class="input-group" style="width:100%">
				 <input id="tel" name="tel" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入电话"  ignore="ignore" />
			 </div>
		 </div>
	 </div>
	 <div class="form-group">
		 ...
		 <div class="col-sm-7">
			 <div class="input-group" style="width:100%">
				 <input id="fax" name="fax" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入传真"  ignore="ignore" />
			 </div>
		 </div>
	 </div>
	 <div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<t:webUploader name="logofilename" outJs="true" auto="true" showImgDiv="filediv_logofilename"></t:webUploader>
				<div class="form" id="filediv_logofilename"></div>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="memo" name="memo" type="text" maxlength="250" class="form-control input-sm" placeholder="请输入备注"  ignore="ignore" />
			</div>
		</div>
	</div>
