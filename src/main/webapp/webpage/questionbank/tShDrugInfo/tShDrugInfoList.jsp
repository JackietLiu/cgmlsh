...
<div class="easyui-layout" fit="true">
	...
	<div id = "tShDrugInfoListToolbar">
		...
		<div class="toolbar-btn">
			...
			<button type="button" class="tool-btn tool-btn-default tool-btn-xs" onclick="JeecgExcelExport('tShDrugInfoController.do?exportXlsByT','tShDrugInfoList')">
				<i class="fa fa-upload"></i>
				<span>模版下载</span>
			</button>
...
function initDatagrid(){
	var actionUrl = "tShDrugInfoController.do?datagrid&field=id,contractname,place,buyno,groupname,commonname,tradename,drugform,gg,rationnum,minpcs,pkccz,enterprisename,suppprice,isactive,agencyshortname,agencyname,memo,drugmemo,registerno,drugcodeent,updateName,updateDate,createDate,createName,drugclass,";
