<!--thisisid: drugClassTreeForSelect.jsp  -->
...
<script type="text/javascript" language="javascript">
    ...
    function clickNode(event, treeId, treeNode, clickFlag) {
        ...
        $("#selectedNameVal").attr("value",nodes[0].name);
        $("#selectedVal").attr("value",nodes[0].id);
    }
...
<div class="easyui-layout" fit="true">
	<div  region="north" style="height: 50px;">
		...
		<button type=button class="btn btn-normal btn-xs"
			...
			<span class="bigger-110 no-text-shadow">查找</span></button>
	</div>
	<!--update-start--Author:luobaoli  Date:20150609 for：panel调整为默认关闭-->
	<div region="center" style="width: 250px;height: 100%;overflow: scroll;" title="药品类别树" split="true" collapsed="false">
		<ul id="theTree" class="ztree">
		</ul>
		<input type="hidden" id="selectedVal" />
		<input type="hidden" id="selectedNameVal" />
	</div>
