...
<div class="easyui-layout" fit="true">
	...
	<div id = "tShHospDrugListListToolbar">
		...
		<div class="toolbar-btn">
			<button type="button" class="tool-btn tool-btn-default tool-btn-xs" onclick="add('录入','tShHospDrugListController.do?goAdd','tShHospDrugListList',768,500)">
				<i class="fa fa-plus"></i>
				<span>录入</span>
			</button>
			
			<button type="button" class="tool-btn tool-btn-default tool-btn-xs" onclick="update('编辑','tShHospDrugListController.do?goUpdate','tShHospDrugListList',768,500)">
				<i class="fa fa-edit"></i>
				<span>编辑</span>
			</button>
			
			<button type="button" class="tool-btn tool-btn-default tool-btn-xs" onclick="deleteALLSelect('批量删除','tShHospDrugListController.do?doBatchDel','tShHospDrugListList',null,null)">
			...
			<button type="button" class="tool-btn tool-btn-default tool-btn-xs" onclick="JeecgExcelExport('tShHospDrugListController.do?exportXlsByT','tShHospDrugListList')">
				<i class="fa fa-upload"></i>
				<span>模版下载</span>
			</button>
		
			<button type="button" class="tool-btn tool-btn-default tool-btn-xs" onclick="$('.toolbar-search').slideToggle(function(){$('#tShHospDrugListList').datagrid('resize');});">
				<i class="fa fa-arrow-circle-left"></i>
				<span>检索</span>
			</button>
			<button type="button" class="tool-btn tool-btn-default tool-btn-xs" onclick="ImportXls();">
