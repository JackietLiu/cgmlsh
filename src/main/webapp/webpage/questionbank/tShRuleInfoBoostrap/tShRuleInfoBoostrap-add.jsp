<!--thisisid: tShRuleInfoBoostrap-add -->
...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="tShRuleInfoBoostrapController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					...
					<div class="col-sm-7">
					<div class="input-group" style="width:100%">
						  	 	<textarea id="ruledesc" class="form-control" rows="6" style="width: 600px" name="ruledesc"  ignore="ignore" ></textarea>
					...
					<div class="col-sm-7">
					<div class="input-group" style="width:100%">
						  	 	<textarea id="resultdesc" class="form-control" rows="6" style="width: 600px" name="resultdesc"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					...
					<div class="col-sm-7">
					<div class="input-group" style="width:100%">
						  	 	<textarea id="rulesql" class="form-control" rows="6" style="width: 600px" name="rulesql"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					...
					<div class="col-sm-7">
					<div class="input-group" style="width:100%">
						  	 	<textarea id="memo" class="form-control" rows="6" style="width: 600px" name="memo"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					...
					<div class="col-sm-7">
					<div class="input-group" style="width:100%">
						  	 	<textarea id="detailsql" class="form-control" rows="6" style="width: 600px" name="detailsql"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
