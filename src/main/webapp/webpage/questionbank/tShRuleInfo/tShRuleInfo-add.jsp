...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="tShRuleInfoController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="rulename" name="rulename" type="text" maxlength="40" class="form-control input-sm" placeholder="请输入规则名称"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
		...
		<%--<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="parms" name="parms" type="text" maxlength="200" class="form-control input-sm" placeholder="请输入参数"  ignore="ignore" />
				</div>
			</div>
		</div>--%>
		...
		<div class="form-group">
						...
						<div class="col-sm-7">
				    <div class="input-group" style="width:100%">
						  	 	<textarea name="ruledesc" value = "${tShRuleInfo.ruledesc}" class="form-control input-sm" rows="3"  ignore="ignore" ></textarea>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
				    <div class="input-group" style="width:100%">
						  	 	<textarea name="resultdesc" value = "${tShRuleInfo.resultdesc}" class="form-control input-sm" rows="3"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
				    <div class="input-group" style="width:100%">
						  	 	<textarea name="memo" value = "${tShRuleInfo.memo}" class="form-control input-sm" rows="3"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
				    <div class="input-group" style="width:100%">
						  	 	<textarea name="allresultdeschaserror" value = "${tShRuleInfo.detailsql}" class="form-control input-sm" rows="3"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<textarea name="allresultdescnoerror" value = "${tShRuleInfo.detailsql}" class="form-control input-sm" rows="3"  ignore="ignore" ></textarea>
					<span class="Validform_checktip" style="float:left;height:0px;"></span>
