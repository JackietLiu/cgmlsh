<!--thisisid: tShDrugInfoJs4import-add.jsp  -->
...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <form id="formobj" action="tShDrugInfoJs4importController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="agencyname" name="agencyname" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入经销商全称"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="agencyshortname" name="agencyshortname" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入经销商简称"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="commonname" name="commonname" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入通用名"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="contractname" name="contractname" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入合同名称"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="drugclass" name="drugclass" type="text" maxlength="40" class="form-control input-sm" placeholder="请输入药品类别"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="drugcodeent" name="drugcodeent" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入公司商品代码"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="drugmemo" name="drugmemo" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入产品备注"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="enterprisename" name="enterprisename" type="text" maxlength="255" class="form-control input-sm" placeholder="请输入生产企业全称"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="groupname" name="groupname" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入评审分组"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="isactive" name="isactive" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入状态"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="minpcs" name="minpcs" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入最小包装单位"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="pkccz" name="pkccz" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入包装材质"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="place" name="place" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入交易场"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="registerno" name="registerno" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入批准文号"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="suppprice" name="suppprice" type="text" maxlength="10" class="form-control input-sm" placeholder="请输入供应价"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="tradename" name="tradename" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入商品名"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
