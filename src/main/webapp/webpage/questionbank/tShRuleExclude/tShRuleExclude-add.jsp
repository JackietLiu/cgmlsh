...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <form id="formobj" action="tShRuleExcludeController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="commonname" name="commonname" type="text" maxlength="1000" class="form-control input-sm" placeholder="请输入通用名"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="isactive" name="isactive" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入是否在用"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="memo" name="memo" type="text" maxlength="200" class="form-control input-sm" placeholder="请输入备注"  ignore="ignore" />
			</div>
		</div>
	</div>
</form>
