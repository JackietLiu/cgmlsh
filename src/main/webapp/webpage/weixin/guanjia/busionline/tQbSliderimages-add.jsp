...
<t:base type="bootstrap,bootstrap-table,layer,validform,webuploader,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="tQbSliderimagesController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="groupname" name="groupname" type="text" maxlength="40" class="form-control input-sm" placeholder="请输入组名"  ignore="checked" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
				<t:webUploader name="imgurl" outJs="true" auto="true" showImgDiv="filediv_imgurl"></t:webUploader>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="imgtitle" name="imgtitle" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入标题"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
				    <div class="input-group" style="width:100%">
						  	 	<textarea name="memo" value = "${tQbSliderimages.memo}" class="form-control input-sm" rows="6"  ignore="ignore" ></textarea>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
				    <div class="input-group" style="width:100%">
						  	 	<textarea name="imgdesc" value = "${tQbSliderimages.imgdesc}" class="form-control input-sm" rows="6"  ignore="ignore" ></textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
