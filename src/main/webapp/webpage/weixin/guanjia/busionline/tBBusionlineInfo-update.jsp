...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBBusionlineInfoController.do?doUpdate" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${tBBusionlineInfoPage.businame}'>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${tBBusionlineInfoPage.businameshort}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" colspan="3">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${tBBusionlineInfoPage.sortindex}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" colspan="3">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${tBBusionlineInfoPage.url}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" colspan="3">
						  	 	<textarea id="memo" style="width: 460px; margin: 0px; height: 70px;" class="inputxt" rows="4" name="memo" 
						  	 	ignore="ignore"
						  	 	>${tBBusionlineInfoPage.memo}</textarea>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/shanyang/busionline/tBBusionlineInfo.js"></script>		
	  	<script type="text/javascript">
		  	...
		  	$(function(){
		  		...
		  		$.ajax({
		  		   type: "post",
		  		   url: "tBBusionlineInfoController.do?getFiles&id=" +  cgFormId,
