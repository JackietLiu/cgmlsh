...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBBusionlineItemController.do?doAdd" callback="jeecgFormFileCallBack@Override">
