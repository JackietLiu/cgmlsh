...
<html>
 ...
 <body>
  ...
  <c:if test="${tbConfigDetail.managerlevel !='Priority_System'  && tbConfigDetail.managerlevel =='Priority_User'}">
     ...
     <c:if test="${tbConfigDetail.managerlevel =='Priority_System' ||tbConfigDetail.managerlevel =='Priority_Ent' ||tbConfigDetail.managerlevel =='Priority_Role' }">
     <font style="font-size: 20px !important;color: red;">该配置项不支持用户配置</font>
    </c:if>
  </c:if>
   <c:if test="${isTbConfigDetail == 'Y'}">
   	 <c:if test="${tbConfigDetail.code !='Priority_System'  && tbConfigDetail.code =='Priority_User'}">
		...
		<c:if test="${tbConfigDetail.code =='Priority_System' ||tbConfigDetail.code =='Priority_Ent' ||tbConfigDetail.code =='Priority_Role' }">
     <font style="font-size: 20px !important;color: red;">该配置项不支持用户配置</font>
    </c:if>    
   </c:if>
 </body>
