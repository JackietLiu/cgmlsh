...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tbConfigDetailController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						    <input id="code" name="code" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${tbConfigDetailPage.code}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="codedetail" name="codedetail" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${tbConfigDetailPage.codedetail}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="thevalue" name="thevalue" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${tbConfigDetailPage.thevalue}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="isactive" name="isactive" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="checked"  value='${tbConfigDetailPage.isactive}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="memo" name="memo" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${tbConfigDetailPage.memo}'/>
							<span class="Validform_checktip"></span>
