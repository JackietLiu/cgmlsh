...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveTypeGroup">
	...
	<input name="typegroupname" class="inputxt" value="${typegroup.typegroupname }"
		datatype="s2-10"> <span class="Validform_checktip">
		<t:mutiLang langKey="common.name.range" langArg="common.name,common.range2to10"/></span></div>
	
	<div class="form">
		<label class="Validform_label"> 备注: </label> 
		<input name="memo" class="inputxt" value="${typegroup.memo }"  > 
		<span class="Validform_checktip">请输入备注信息。</span>
	</div>
	</fieldset>
</t:formvalid>
</body>
