...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <form id="formobj" action="tShDrugValueInfoNewController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="drugform" name="drugform" type="text" maxlength="20" class="form-control input-sm" placeholder="请输入drugform"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
