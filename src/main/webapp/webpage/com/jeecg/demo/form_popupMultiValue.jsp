				...
				<tbody>
					<tr>
						<td class="value">							
						     ...
						     <input onclick="popupClick(this,'account,realname','account,realname','user_msg');"
									placeholder="点击选择用户" name="demos[0].name" type="text"
									style="cursor: pointer;" class="inputxt" value="">
						</td>
						<td class="value">
					...
					<tr>
						<td class="value">							
						     ...
						     <input onclick="popupClick(this,'account,realname','account,name','user_msg');" placeholder="点击选择用户2" name="demos[1].name" type="text" style="cursor: pointer;" class="inputxt" value="">
						</td>
						<td class="value">
