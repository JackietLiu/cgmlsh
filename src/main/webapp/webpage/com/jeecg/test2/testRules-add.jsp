...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="testRulesController.do?doAdd">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1"
			...
			<tr>
				...
				<td class="value"><input id="name" name="name" type="text"
					...
					class="Validform_label" style="display: none;">销售人员</label></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="value"><input id="product" name="product"
					...
					class="Validform_label" style="display: none;">产品名字</label></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="value"><input id="dda" name="dda" type="text"
					maxlength="32" style="width: 150px" class="inputxt" ignore="ignore" />
					<span class="Validform_checktip"></span> <label
					class="Validform_label" style="display: none;">dd</label></td>
			</tr>
			...
			<tr>
				...
				<td class="value"><script type="text/javascript"
					...
					<script type="text/javascript" charset="utf-8"
						...
						name="eeee" id="eeee" style="width: 650px; height: 300px"></textarea>
					<script type="text/javascript">
